    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          ...
          case 10: break;
          case 2: 
            { System.out.println("Token é do tipo 'identifier': '"+yytext()+"' na linha: "+yyline+" e coluna: "+yycolumn);
            }
          case 11: break;
          case 3: 
            { /* Ignorar whitespace. */
          ...
          case 14: break;
          case 6: 
            { System.out.println("Token é do tipo 'operator': '"+yytext()+"' na linha: "+yyline+" e coluna: "+yycolumn);
            }
          case 15: break;
          case 7: 
            { System.out.println("Token é do tipo 'delimiter': '"+yytext()+"' na linha: "+yyline+" e coluna: "+yycolumn);
            }
          case 16: break;
          case 8: 
            { System.out.println("Token é do tipo 'integer': '"+yytext()+"' na linha: "+yyline+" e coluna: "+yycolumn);
            }
          case 17: break;
          case 9: 
            { System.out.println("Token é do tipo 'reserved': '"+yytext()+"' na linha: "+yyline+" e coluna: "+yycolumn);
            }
          case 18: break;
          default:
